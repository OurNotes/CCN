...
```shell
cd /usr/local/redis/perform/src
./redis-cli --cluster create 10.10.2.9:6666 10.10.2.9:6667 10.10.2.9:6668 10.10.2.9:6669 10.10.2.9:6670 10.10.2.9:6671
```
