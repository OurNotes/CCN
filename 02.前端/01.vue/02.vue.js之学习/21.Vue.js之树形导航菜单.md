...
```html
<template>
    <el-menu class="el-menu-vertical-demo" default-active="UserContainers" unique-opened @select="handleSelect">
      <template v-for="list in menu">
        ...
        <el-submenu v-if="list.children" :index="String(list.menuID)" :key="list.menuID">
          ...
          <el-menu-item-group>
            <ThreeMenu :menu="list.children" v-if="list.children" @three="(menuCode)=>$emit('three',menuCode)"></ThreeMenu>
          </el-menu-item-group>
        </el-submenu>
